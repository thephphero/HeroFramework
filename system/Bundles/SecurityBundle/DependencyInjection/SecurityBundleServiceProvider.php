...
use Bundles\SecurityBundle\Security\Encoders\Sha256PasswordEncoder;
use Bundles\SecurityBundle\Security\Listeners\AnonymousAuthenticationListener;
use Bundles\SecurityBundle\Security\Listeners\UserPermissionsExceptionListener;
...
use Bundles\SecurityBundle\Security\UserProviders\TokenUserProvider;
