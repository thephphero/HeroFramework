 ...
 */
namespace Bundles\FrameworkBundle\Security\UserProviders;


use Bundles\FrameworkBundle\Security\Repositories\TokenUser;
...
class TokenUserProvider implements UserProviderInterface{
    ...
    {
        return $class === '\\Bundles\\FrameworkBundle\\Security\\Repositories\\TokenUser';
    }
}